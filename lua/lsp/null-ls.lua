...
local sources = {b.formatting.prettier.with({
    ...
    filetypes = {"teal", "tridactyl"}
}), b.formatting.fish_indent, b.formatting.shfmt, b.diagnostics.write_good, b.diagnostics.markdownlint,
                 b.diagnostics.teal, b.diagnostics.shellcheck.with({
